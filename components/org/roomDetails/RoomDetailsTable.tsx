      ...
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-transparent">
            ...
            <TableHead className="min-w-[6rem]">Room no</TableHead>
            <TableHead className="min-w-[10rem]">Description</TableHead>
            <TableHead className="min-w-[5rem] text-right">Adult</TableHead>
            <TableHead className="min-w-[5rem] text-right">Child</TableHead>
            <TableHead className="min-w-[7rem]">Booking</TableHead>
